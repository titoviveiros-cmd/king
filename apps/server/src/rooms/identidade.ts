...
/**
 * ══ AQUI MORAVA `avatarLivre` ══
 *
 * Ela devolvia "o próximo bicho livre" quando o pedido estava ocupado, e a sala usava isso para
 * sentar a pessoa com um avatar que ela não escolheu. Parecia gentil e não era: quem salvou o
 * Sapo no aparelho entrava como Coruja sem ter pedido nada, e só descobria reparando no próprio
 * card. Avatar é identidade, e identidade não se atribui em silêncio.
 *
 * A regra passou a ser: ocupado vira PENDENTE, e a pessoa escolhe. A função sai junto com o
 * comportamento — deixá-la aqui seria deixar a armadilha montada para o próximo.
 */
